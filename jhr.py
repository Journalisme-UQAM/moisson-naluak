...
### Ne manquent que des commentaires pour comprendre ce qui se passe,
### et un affichage dans le terminal pour suivre le moissonnage au fur et à mesure qu'il s'effectue
...
fichier = "Bishop_PROF_JHR.csv" ### Je rebaptise ton nom de fichier pour effectuer mes tests
f2 = open(fichier,"w")
...
for lettreOrd in range(ord("A"), ord("Z")+1):
	...
	for prof in profs:
		...
		title = "Titre Inconnu" ### Très bonne solution pour les cas où la page ne contient pas l'info recherchée!
		if titleHtml != None:
		...
		print([university, title, prenom, nom, domaine, courriel, nbTel, url]) ### Pourquoi avoir mis cette ligne en commentaire? C'est utile de suivre le travail de ton script
